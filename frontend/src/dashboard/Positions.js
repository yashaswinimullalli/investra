...
const Positions = () => {
  ...
  if (loading) return <div className="orders"><div className="no-orders"><p>Loading positions...</p></div></div>;
  if (allPositions.length === 0) return (
    <>
      <h3 className="title">Positions (0)</h3>
      <div className="orders"><div className="no-orders"><p>No open positions</p></div></div>
    </>
  );
