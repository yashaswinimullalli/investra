...
const Summary = () => {
  ...
  useEffect(() => {
    axios.get("https://investra-f0c2.onrender.com/allHoldings").then((res) => setHoldings(res.data)).catch(() => {});
    axios.get("https://investra-f0c2.onrender.com/allOrders").then((res) => setOrders(res.data)).catch(() => {});
  }, []);
