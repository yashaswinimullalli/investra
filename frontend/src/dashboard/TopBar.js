      ...
      <div className="topbar-container">
        <div className="indices-container">
          <div className="nifty">
            ...
            <p className="percent" style={{ color: indices.nifty.up === false ? "rgb(223,73,73)" : "rgb(72,194,55)" }}>{indices.nifty.change}</p>
          </div>
          <div className="sensex">
            <p className="index">SENSEX</p>
            <p style={indexStyle(indices.sensex.up)}>{indices.sensex.price}</p>
            <p className="percent" style={{ color: indices.sensex.up === false ? "rgb(223,73,73)" : "rgb(72,194,55)" }}>{indices.sensex.change}</p>
          </div>
        </div>
        <Menu />
      </div>
